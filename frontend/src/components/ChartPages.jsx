    ...
    <div className="min-h-screen bg-white text-[#0D1B2E] flex flex-col">
      <div className="flex-1 px-12 py-16">
        ...
        <div className="bg-gray-50 p-8 rounded-lg mb-8">
                ...
                <div key={rowIdx} className="flex gap-1 mb-1">
                  ...
                  {row.map((value, colIdx) => {
                    ...
                    return (
                      <div 
                        key={colIdx} 
                        className="w-20 h-12 flex items-center justify-center font-bold text-sm rounded"
                        style={{ backgroundColor: bgColor, color: intensity > 0.5 ? 'white' : '#0D1B2E' }}
                      >
                        {value}K
                      </div>
                    );
          ...
          {/* Regional Data */}
          <div className="mt-8">
            <h3 className="font-bold text-xl mb-4">Sales by Region (July)</h3>
            <ResponsiveContainer width="100%" height={250}>
              <BarChart data={heatmapData.regionalData} layout="vertical">
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis type="number" />
